...
def train():
    ...
    # Custom log directory for V2 Hybrid
    log_dir = os.path.join(config.modelconfig["log_path"] + "_v2_hybrid")
    ...
    writer.close()
    print(f"\nTraining finished! Best Test ACC for V2 Hybrid: {best_test_acc:.3f}")
